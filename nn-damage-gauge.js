...
let NNDamageGauge = class NNDamageGauge extends LitElement {
    hp = 100;
    step = 5;
    undead = false;
    get value() {
...
], NNDamageGauge.prototype, "hp", void 0);
__decorate([
    property({ type: Number })
], NNDamageGauge.prototype, "step", void 0);
__decorate([
    property({ type: Boolean })
], NNDamageGauge.prototype, "undead", void 0);
__decorate([
    property({ type: Number })
], NNDamageGauge.prototype, "value", null);
__decorate([
    state()
], NNDamageGauge.prototype, "gauge", void 0);
__decorate([
    state()
], NNDamageGauge.prototype, "active", void 0);
__decorate([
    state()
], NNDamageGauge.prototype, "shakeInterval", void 0);
__decorate([
    state()
], NNDamageGauge.prototype, "dead", void 0);
NNDamageGauge = __decorate([
    customElement('nn-damage-gauge')
], NNDamageGauge);
export { NNDamageGauge };
//# sourceMappingURL=nn-damage-gauge.js.map